...
// (DO NOT EDIT: machine generated header) 'System.IOUtils.pas' rev: 35.00 (Windows)
...
#include <Winapi.KnownFolders.hpp>
...
namespace Ioutils
{
extern DELPHI_PACKAGE void __fastcall DirectoryCopyCPP(const System::UnicodeString SourceDirName, const System::UnicodeString DestDirName, bool IgnoreErrors);
}	/* namespace Ioutils */
}	/* namespace System */
...
struct TDirectory;
struct TDirectoryHelper /* Helper for record 'TDirectory' */;
struct TPath;
struct TFile;
//-- type declarations -------------------------------------------------------
