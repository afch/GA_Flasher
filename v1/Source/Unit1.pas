...
begin
  ...
  0,1,2,3: begin CPU:='atmega328p'; Programmer:=' -carduino';end;
  4: begin CPU:='atmega2560';Programmer:=' -cwiring'; end;
  end;
  ...
  Params:='-Cavrdude.conf -v -p'+CPU+Programmer+' -P'+ComboBox.Text+' -b115200 -D -Uflash:w:"'+OpenDialog1.FileName+'":i';
